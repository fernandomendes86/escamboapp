class Site::Profile::AdsController < Site::ProfileController
	...
	before_action :ad_is_the_member?, only: [:edit, :update]
	...
	private
		...
		def ad_is_the_member?
			unless @ad.member.id == current_member.id
				redirect_to site_profile_ads_path, alert: "Acesso não permitido"
			end
		end
